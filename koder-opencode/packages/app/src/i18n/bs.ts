export const dict = {
  ...
  "prompt.example.1": "Popravi TODO u bazi vectosilo",
  ...
  "prompt.example.19": "Dodaj logovanje kroz cijelu bazu vectosilo",
  ...
  "settings.general.row.font.description": "Prilagodi font koji se koristi u blokovima vectosilo",
