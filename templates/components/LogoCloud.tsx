      ...
      <div className="mx-auto max-w-6xl">
        {title && (
          <motion.p
            ...
            viewport={{ once: true }}
            className="mb-8 text-center text-xs font-medium uppercase tracking-widest text-koda-muted"
          >
            {title}
          </motion.p>
        )}
        ...
        {animated ? (
          <div className="relative overflow-hidden" ref={trackRef}>
            ...
            <div className="pointer-events-none absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-koda-bg to-transparent" />
            <div className="pointer-events-none absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-koda-bg to-transparent" />
          </div>
        ) : (
          <motion.div
            initial="hidden"
