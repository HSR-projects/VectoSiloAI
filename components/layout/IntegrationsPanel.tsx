...
export function IntegrationsPanel() {
  const githubConnected = useKodaStore((s) => s.githubConnected);
          ...
          >
            ...
            {gh?.connected ? (
              ...
              <button
                onClick={connect}
                disabled={busy}
                className="inline-flex items-center gap-1 rounded-lg border border-koda-accent/30 bg-koda-accent/10 px-2.5 py-1 text-[11px] font-medium text-koda-accent-soft transition-colors hover:bg-koda-accent/20"
              >
            ...
            {gh?.connected && (
              <button
                onClick={disconnect}
                disabled={busy}
                className="rounded-lg px-2 py-1 text-[11px] text-koda-muted transition-colors hover:bg-red-500/10 hover:text-red-400"
              >
                Disconnect
              </button>
            )}
