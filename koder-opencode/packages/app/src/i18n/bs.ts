export const dict = {
  ...
  "prompt.example.1": "Popravi TODO u bazi incogni",
  ...
  "prompt.example.19": "Dodaj logovanje kroz cijelu bazu incogni",
  ...
  "settings.general.row.font.description": "Prilagodi font koji se koristi u blokovima incogni",
