...
:::tip
Koristite agenta plana za analizu vectosilo i pregled prijedloga bez ikakvih promjena vectosilo.
:::
...
Ovaj agent je koristan kada želite da LLM analizira kod, predloži promjene ili kreira planove bez stvarnih modifikacija vaše baze vectosilo.
...
- **0.0-0.2**: Vrlo fokusirani i deterministički odgovori, idealni za analizu i planiranje vectosilo
