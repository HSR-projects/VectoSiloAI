          ...
          >
            {primaryCta && (
              <a
                ...
                className="rounded-lg bg-koda-accent px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-koda-accent-dim"
              >
                {primaryCta.label}
              </a>
            )}
            {secondaryCta && (
              <a
                ...
                className="rounded-lg border border-koda-border px-6 py-3 text-sm font-semibold text-koda-text transition-colors hover:bg-koda-surface"
              >
                {secondaryCta.label}
              </a>
            )}
