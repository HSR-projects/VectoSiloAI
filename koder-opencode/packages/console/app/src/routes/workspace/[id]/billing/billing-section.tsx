...
import { IconAlipay, IconCreditCard, IconUpi, IconWechat } from "~/component/icon"
...
export function BillingSection() {
  ...
  async function onClickCheckout() {
    ...
    if (checkout && checkout.data && checkout.data.startsWith("http")) {
              ...
              <div data-slot="credit-card">
                <div data-slot="card-icon">
                  <Switch fallback={<IconCreditCard style={{ width: "24px", height: "24px" }} />}>
                    <Match when={billingInfo()?.paymentMethodType === "link"}>
                      <IconCreditCard style={{ width: "24px", height: "24px" }} />
                    </Match>
                ...
                <div data-slot="card-details">
                  <Switch>
                    ...
                    <Match when={billingInfo()?.paymentMethodType === "link"}>
                      <span data-slot="type">{i18n.t("workspace.billing.linkedToRazorpay")}</span>
                    </Match>
                    <Match when={billingInfo()?.paymentMethodType === "alipay"}>
