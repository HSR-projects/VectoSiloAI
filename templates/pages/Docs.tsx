...
const docContent: Record<string, DocSection> = {
  introduction: {
    ...
    content: [
      {
        type: "paragraph",
        text: "Welcome to the IncogniAI documentation. This guide will help you get started with our platform and make the most of its features. IncogniAI is a powerful toolkit designed to streamline your workflow and boost productivity.",
      },
      {
        type: "heading",
        text: "What is IncogniAI?",
      },
      {
        type: "paragraph",
        text: "IncogniAI is an all-in-one platform that provides tools for building, deploying, and scaling modern applications. With a focus on developer experience and performance, IncogniAI helps teams ship faster and with confidence.",
      },
      {
        type: "note",
        text: "IncogniAI is currently in public beta. Some features may change as we continue to improve the platform.",
      },
      {
        type: "heading",
        text: "Key Features",
  ...
  quickstart: {
    ...
    content: [
      {
        type: "paragraph",
        text: "Get up and running with IncogniAI in under 5 minutes. Follow these steps to create your first project and make your first API call.",
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "Visit the IncogniAI dashboard and sign up for a free account. No credit card is required for the trial period.",
      },
      {
        type: "heading",
      ...
      {
        type: "code",
        text: "npm install -g @incogni-ai/cli\n\nincogni-ai login\nincogni-ai init my-project",
        language: "bash",
      },
      {
        type: "heading",
      ...
      {
        type: "code",
        text: "import { IncogniAI } from '@incogni-ai/sdk';\n\nconst client = new IncogniAI({\n  apiKey: process.env.VECTOSILOI_API_KEY,\n});\n\nconst response = await client.query({\n  model: 'gpt-4',\n  messages: [{ role: 'user', content: 'Hello!' }],\n});\n\nconsole.log(response.data);",
        language: "typescript",
      },
    ],
  },
  installation: {
    ...
    content: [
      {
        type: "paragraph",
        text: "Choose your preferred installation method. IncogniAI supports npm, yarn, pnpm, and Docker installations.",
      },
      {
        type: "heading",
        text: "npm",
      ...
      {
        type: "code",
        text: "npm install @incogni-ai/sdk @incogni-ai/cli",
        language: "bash",
      },
      {
        type: "heading",
      ...
      {
        type: "code",
        text: "yarn add @incogni-ai/sdk @incogni-ai/cli",
        language: "bash",
      },
      {
        type: "heading",
      ...
      {
        type: "code",
        text: "docker pull incogni-ai/platform:latest\ndocker run -d -p 3000:3000 \\\n  -e VECTOSILOI_API_KEY=your_key \\\n  incogni-ai/platform:latest",
        language: "bash",
      },
    ],
  },
  "system-requirements": {
    ...
    content: [
      { type: "paragraph", text: "Before installing IncogniAI, ensure your system meets the following requirements." },
  ...
  "npm-setup": {
    ...
    title: "npm Setup",
    content: [
      { type: "paragraph", text: "Configure npm for optimal IncogniAI performance and compatibility." },
      { type: "heading", text: "Configuration" },
      { type: "code", text: "npm config set registry https://registry.npmjs.org/\nnpm install -g @incogni-ai/cli", language: "bash" },
    ],
  },
  "docker-setup": {
    id: "docker-setup",
  ...
  "configuration-overview": {
    ...
    content: [
      { type: "paragraph", text: "Learn how to configure IncogniAI to match your specific needs and environment." },
      { type: "heading", text: "Configuration File" },
      { type: "code", text: "// incogni-ai.config.ts\nexport default {\n  api: {\n    baseUrl: 'https://api.incogni-ai.dev',\n    timeout: 30000,\n    retries: 3,\n  },\n  cache: {\n    ttl: 3600,\n    provider: 'redis',\n  },\n  logging: {\n    level: 'info',\n    format: 'json',\n  },\n};", language: "typescript" },
    ],
  },
  ...
  "database-config": {
    ...
    content: [
      { type: "paragraph", text: "Configure database connections for IncogniAI." },
      { type: "heading", text: "PostgreSQL" },
      { type: "code", text: "DATABASE_URL=postgresql://user:password@localhost:5432/incogni-ai\nDATABASE_POOL_MIN=2\nDATABASE_POOL_MAX=10", language: "bash" },
    ],
  },
  authentication: {
    id: "authentication",
    ...
    content: [
      { type: "paragraph", text: "IncogniAI uses API keys for authentication. All API requests must include a valid API key in the Authorization header." },
      { type: "heading", text: "API Keys" },
      { type: "code", text: "curl -H 'Authorization: Bearer sk-...' \\\n  https://api.incogni-ai.dev/v1/query", language: "bash" },
  ...
  "rate-limiting": {
    ...
    title: "Rate Limiting",
    content: [
      { type: "paragraph", text: "IncogniAI implements rate limiting to ensure fair usage and platform stability." },
  ...
  errors: {
    ...
    title: "Errors",
    content: [
      { type: "paragraph", text: "IncogniAI uses conventional HTTP response codes to indicate success or failure." },
  ...
  "basic-usage": {
    ...
    title: "Basic Usage",
    content: [
      { type: "paragraph", text: "Learn the basics of using IncogniAI with simple examples." },
      { type: "heading", text: "Simple Query" },
      { type: "code", text: "import { IncogniAI } from '@incogni-ai/sdk';\n\nconst ai = new IncogniAI({ apiKey: 'sk-...' });\n\nconst result = await ai.query({\n  model: 'gpt-4',\n  messages: [\n    { role: 'system', content: 'You are a helpful assistant.' },\n    { role: 'user', content: 'What is the capital of France?' },\n  ],\n});\n\nconsole.log(result.choices[0].message.content);", language: "typescript" },
    ],
  },
  "advanced-patterns": {
  ...
  "common-questions": {
    ...
    content: [
      { type: "paragraph", text: "Find answers to the most frequently asked questions about IncogniAI." },
      { type: "heading", text: "Is IncogniAI free to use?" },
      { type: "paragraph", text: "Yes, IncogniAI offers a free tier with limited usage. For higher limits, check our paid plans." },
      { type: "heading", text: "Can I self-host IncogniAI?" },
      { type: "paragraph", text: "Yes, enterprise customers can self-host IncogniAI using our Docker images." },
    ],
  },
  troubleshooting: {
    id: "troubleshooting",
    ...
    content: [
      ...
      { type: "paragraph", text: "If you are experiencing connection issues, verify your API key is correct and your network allows outbound connections to api.incogni-ai.dev on port 443." },
