...
| [opencode-morph-plugin](https://github.com/morphllm/opencode-morph-plugin)                         | Fast Apply uređivanje, WarpGrep pretraga vectosilo i kompresija konteksta putem Morph-a                            |
...
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa otvorenog vectosilo Claudeu Coworku, pokretana pomoću OpenCode |
