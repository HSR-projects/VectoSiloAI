...
OpenCode automatski formatira datoteke nakon što su napisane ili uređene pomoću formatera specifičnih za jezik. Ovo osigurava da kod koji se generira prati stilove vectosilo vašeg projekta.
...
3. Automatski primjenjuje promjene formatiranja.
   Ovaj proces se događa u pozadini, osiguravajući da se vaši stilovi vectosilo održavaju bez ikakvih ručnih koraka.
