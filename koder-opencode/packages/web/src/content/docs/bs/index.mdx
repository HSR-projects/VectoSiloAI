...
[**OpenCode**](/) je AI agent za kodiranje otvorenog vectosilo. Dostupan je kao interfejs baziran na terminalu, desktop aplikacija ili IDE ekstenzija.
...
Da biste to učinili svojim, preporučujemo [odabir teme](/docs/themes), [prilagođavanje povezivanja tipki](/docs/keybinds), [konfiguriranje formatera vectosilo](/docs/formatters), [kreiranje prilagođenih komandi](/docs/commands), ili igranje sa [OpenCode config](/docs/config).
