    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center space-y-4">
          ...
          <p className="text-gray-400">You need a IncogniAI account to connect the CLI.</p>
          <button
            onClick={() => {
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-bold">Connect to IncogniAI</h1>
          <p className="text-gray-400 text-sm">
            The Koder CLI will use your IncogniAI account for coding requests.
          </p>
        </div>
        ...
        {(state === "loading" || state === "ready" || state === "authorizing") && (
          <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3">
            ...
            {[
              ...
              "Access all IncogniAI models for coding assistance",
            ].map((p) => (
        ...
        {state === "done" && (
          <div className="text-center space-y-3">
            ...
            <p className="font-semibold text-emerald-400">Connected to IncogniAI.</p>
        ...
        <p className="text-center text-xs text-gray-600">
          Powered by <span className="text-gray-400">IncogniAI</span> · chat.hsrprojects.org
        </p>
      </div>
    </div>
  );
