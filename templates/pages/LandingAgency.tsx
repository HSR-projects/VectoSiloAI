  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-koda-bg">
        <Navbar
          logo={<span className="text-xl font-bold text-koda-text">StudioK</span>}
          links={navLinks}
          cta={
            <a
              href="#"
        ...
        <HeroSplit
          ...
          image={
            <div className="flex h-80 w-full items-center justify-center rounded-2xl bg-gradient-to-br from-koda-accent/20 via-purple-500/20 to-koda-surface-2">
              <div className="text-center">
                <PenTool className="mx-auto h-16 w-16 text-koda-accent/60" />
                <p className="mt-4 text-sm text-koda-muted">Creative Studio Showreel</p>
              </div>
            </div>
          }
        />
        ...
        <section className="relative overflow-hidden py-24">
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-4xl font-bold text-koda-text sm:text-5xl"
            >
            ...
            <motion.p
              ...
              className="mt-4 text-lg text-koda-muted"
            >
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <div className="flex gap-6 text-sm text-koda-muted">
                <a href="#" className="hover:text-koda-text transition-colors">Dribbble</a>
                <a href="#" className="hover:text-koda-text transition-colors">Behance</a>
